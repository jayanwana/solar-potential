              ...
              <div className="container px-4 mx-auto">
                  ...
                  <div className="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
                    <a href='/map'>
                          ...
                          <h5 className="text-xl font-medium uppercase mb-4">Maps</h5>
                      ...
                      <div className="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
                        <a href='/table'>
                          <span className="w-20 border-t-2 border-solid border-indigo-200 inline-block mb-3"></span>
                          <h5 className="text-xl font-medium uppercase mb-4">Tables</h5>
                          <div className='w-32 h-32 mx-auto'>
                      ...
                      <div className="md:w-1/3 md:px-4 xl:px-6 mt-8 md:mt-0 text-center">
                          <span className="w-20 border-t-2 border-solid border-indigo-200 inline-block mb-3"></span>
                          <h5 className="text-xl font-medium uppercase mb-4">Panels</h5>
                          <div className='w-32 h-32 mx-auto'>
